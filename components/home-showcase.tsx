...
export function HeroStats({ locale }: { locale: Locale }) {
  ...
  return (
    <div className="hero-stats relative z-10 mx-auto w-full max-w-6xl px-5">
      <div className="overflow-hidden rounded-[1.6rem] border border-white/55 bg-white/[.82] shadow-[0_24px_65px_rgba(2,16,34,.22),inset_0_1px_0_rgba(255,255,255,.9)] backdrop-blur-2xl backdrop-saturate-150">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3.5">
                  <span className="mt-0.5 grid h-9 w-9 shrink-0 place-items-center rounded-xl border border-blue-100/80 bg-blue-50/90 text-blue-700 shadow-[inset_0_1px_0_rgba(255,255,255,.9)]">
