...
export const dictionary = {
  zh: {
    ...
    tagline: "专业 · 诚信 · 高效",
    hero: "专业处理罚单与移民相关事务，为您的合法权益保驾护航",
    heroSub: "以清晰的方案、及时的响应和可靠的专业支持，帮助您稳妥面对每一步。",
    consult: "预约免费咨询",
    services: "查看服务",
    trust: ["10+ 年专业经验", "99% 成功处理率", "数千成功案例", "双语贴心服务"],
    footer: "为每一次重要选择，提供可靠支持。",
    language: "English",
  ...
  en: {
    ...
    heroSub:
      "Clear strategies, prompt communication, and reliable professional support at every step.",
    ...
    footer: "Reliable support for every important decision.",
    language: "中文",
    formSent: "We received your request and will contact you soon.",
  },
} as const;
