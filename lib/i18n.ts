...
export const dictionary = {
  zh: {
    name: "永盛罚单/移民咨询中心", shortName: "永盛咨询中心", nav: ["首页", "服务项目", "案例展示", "相关知识", "关于我们", "联系我们"],
  ...
  en: {
    name: "Yongsheng Ticket & Immigration Consulting Center", shortName: "Yongsheng Consulting", nav: ["Home", "Services", "Case Results", "Guides", "About Us", "Contact"],
...
export const pageSlugs = ["", "services", "cases", "guides", "about", "contact"] as const;
