...
import { getPublicCasesPage, getTaxonomy } from "@/lib/content";
  ...
  return (
    <>
      <PageHero
        ...
        kicker="CASE RESULTS"
        title={
          zh ? "真实案例，清晰呈现处理重点。" : "Real cases, clearly organized."
        }
        description={
          zh
            ? "按大类、罚单类型和地区浏览公开脱敏案例。具体结果仍须结合个案事实、记录和管辖规则评估。"
            : "Browse anonymized matters by category, ticket type, and region. Every outcome depends on the facts, record, and jurisdiction."
        }
