...
import { Checklist, ConsultationCallout, PageHero, SectionHeading } from "@/components/shared";
...
export default async function About({ params }: { params: Promise<{ locale: Locale }> }) {
  ...
  const copy = zh
    ? [
        "纽约罚单处理中心位于法拉盛中心地带，是服务纽约华人社区的专业交通罚单处理机构。我们拥有丰富的纽约交通法律知识和罚单处理经验，致力于为客户提供最专业、最高效的罚单处理服务。",
  ...
  const checklist = zh
    ? ["熟悉纽约交通罚单的常见处理流程", "重视驾照积分、保险与后续影响", "服务纽约华人社区，沟通清晰直接"]
